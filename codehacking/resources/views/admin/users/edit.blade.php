...
@section('content')
  ...
  <div class="row">
  <div class="col-sm-3">
    <img height="50" src="{{$user->photo ? $user->photo->file : 'http://placehold.it/200x200'}}" alt="" class="img-responsive img-rounded">
  </div>  
  ...
  <div class="col-sm-9">
   ...
   <div class="form-group">
    ...
    {!! Form::file('photo_id',array(1 => 'Active', 0 => 'Not ative'),1,['class'=>'form-control']) !!}
